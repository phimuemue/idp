...
\begin{figure}[h!t]
\centering
  \quad \subfloat[Momentum error of $p_1^L$, $p_1^R$, $p_3^L$ resp. $p_3^R$ for equidistant support points at $\{0, \frac{1}{2}, 1\}$] {
  ...
  \hspace{.3cm}
  \quad \subfloat[Momentum error of $p_2^L$ resp. $p_2^R$ for equidistant support points at $\{0, \frac{1}{2}, 1\}$] {
  ...
  % \quad \subfloat[Height and momentum of $p_3^L$ resp. $p_3^R$.] {
  ...
  % }
  % \quad \subfloat[Height and momentum of $p_1^R$.] {
  ...
  % }
  % \quad \subfloat[Height and momentum of $p_2^R$.] {
  ...
  % }
  % \quad \subfloat[Height and momentum of $p_3^R$.] {
  ...
  \quad \subfloat[Momentum error for point $p_1^L$, $p_3^L$, $p_1^R$ resp. $p_3^R$ for support points at $\{-\frac{\sqrt{15}}{10}\pm\frac{1}{2}, 0\}$] {
    % \begin{tikzpicture}
  ...
  \hspace{.3cm}
  \quad \subfloat[Momentum error for point $p_2^L$ resp. $p_2^R$ for support points at $\{-\frac{\sqrt{15}}{10}\pm\frac{1}{2}, 0\}$] {
    % \begin{tikzpicture}
