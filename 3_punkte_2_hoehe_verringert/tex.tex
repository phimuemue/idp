...
\begin{figure}[h!t]
\centering
  % \quad \subfloat[Height of point $p_1^L$] {
  ...
  % }
  % \quad \subfloat[Momentum of point $p_2^L$] {
  ...
  % \quad \subfloat[Momentum of point $p_3^L$] {
  ...
  %   \end{tikzpicture}
  % }
  \quad \subfloat[Momentum of point $p_1^L$ resp. $p_3^L$] {
  ...
  \quad \subfloat[Momentum of point $p_1^R$ resp. $p_3^R$] {
  ...
  \quad \subfloat[Momentum of point $p_2^R$] {
  ...
  % \quad \subfloat[Momentum of point $p_3^R$] {
