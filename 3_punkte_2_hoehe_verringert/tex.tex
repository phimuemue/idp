...
\begin{figure}[h!t]
\centering
  % \subfloat[Height of point $p_1^L$] {
  ...
  % \subfloat[Momentum of point $p_3^L$] {
  ...
  %   \end{tikzpicture}
  % }
  \subfloat[Momentum of point $p_1^L$ resp. $p_3^L$] {
  ...
  \subfloat[Momentum of point $p_1^R$ resp. $p_3^R$] {
  ...
  % \subfloat[Momentum of point $p_3^R$] {
