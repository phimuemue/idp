...
%   \end{tikzpicture}
% }
\caption{Three points for each triangle. All points except $p_1$ have height 10, impulse 0. Point $p_1$ is set to $(9,0)$. Especially the plots for $p_2^L$, $p_3^L$ and $p_3^R$ have changed notably.}
