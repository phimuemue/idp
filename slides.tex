...
\begin{frame}
  ...
  \item Approximate
    ...
    \item $\mathbf{q}_i$ independent of $x$ and $y$ (in contrast to $F(\mathbf{q})$) $\rightarrow$ allows matrix formulations/simplifications
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{block}{Stiffness term accuracy analysis}
    ...
    \item   Remark: Approximation exact for height
      ...
      $\rightarrow$ only consider impulse error
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{Stiffness matrix --- sum approximation}
  \begin{eqnarray*}
    \hspace{-.2cm}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Above computation too expensive / not feasible
