...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[scale=1]{sample-screenshot.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \item Error mainly influenced by $h$ component
  \item Error unbounded (but one uses only reasonable values for $h$)
  \end{itemize}
\end{frame}
