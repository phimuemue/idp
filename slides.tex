...
\begin{frame}
  ...
  \begin{center}
    $\Rightarrow$ Quality of approximation measured by $I := \int\limits_{x=0}^1 | N(x) - N'(x) |\ dx$
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \end{equation*}
  \begin{itemize}
  \item $N$ might have discontinuities (w.r.t. $x$ -- depending upon $h_i$ and $u_i$) 
  ...
  \item General analytic calculations seem too complicated
    ...
    \begin{column}{.45\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=1.5]
          ...
          \draw[color=lightgray,-] (0,0) rectangle (0.5,1.890625);
          \draw[color=lightgray,-] (0.5,0) rectangle (1,1.296875);
          \draw[color=lightgray,-] (1,0) rectangle (1.5,,0.828125);
          \draw[color=lightgray,-] (1.5,0) rectangle (2,1.234375);
