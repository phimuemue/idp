...
\title[]{Approximation Analysis of the Stiffness Term in the Context of Shallow Water Equations}
...
\begin{frame}
  ...
  \item Triangulation of the whole area
...
\begin{frame}
  \frametitle{Stiffness matrix --- point-wise approximation}
  \begin{eqnarray*}
  ...
  \item Point-wise approximation introduces error $\rightarrow$ how big?
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item Too expensive / not feasible
    ...
    $\rightarrow$ Use point-wise approximation:
  \end{itemize}
  \begin{align*}
