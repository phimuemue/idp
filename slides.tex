...
\begin{frame}
  ...
  Goal: Invertible mass matrix $M$
  \begin{itemize}
  \item Low degree of basis functions: Choose specific support points
  \item Higher degree: points derived by Dunavant
  \end{itemize}
  ...
  \begin{figure}[ht]
    ...
    \subfigure[Degree 0]{
      \begin{tikzpicture}[scale=1.5]
        ...
        \draw[fill=blue] (0.33333333, 0.3333333333) circle (0.02);
      \end{tikzpicture}
    }
    \subfigure[Degree 1]{
      \begin{tikzpicture}[scale=1.5]
    ...
    \subfigure[Degree 3]{
      \begin{tikzpicture}[scale=1.5]
        \draw[opacity=1] (0,0) -- node[left]{$e_3$} (0,1) -- node[right]{$e_2$} (1,0) -- node[below]{$e_1$} (0,0);
        \draw[fill=blue] (0.501426509658179, 0.24928674517091) circle (0.02);
        \draw[fill=blue] (0.24928674517091, 0.24928674517091) circle (0.02);
        \draw[fill=blue] (0.24928674517091, 0.501426509658179) circle (0.02);
        \draw[fill=blue] (0.873821971016996, 0.063089014491502) circle (0.02);
        \draw[fill=blue] (0.063089014491502, 0.063089014491502) circle (0.02);
        \draw[fill=blue] (0.063089014491502, 0.873821971016996) circle (0.02);
        \draw[fill=blue] (0.053145049844817, 0.310352451033784) circle (0.02);
        \draw[fill=blue] (0.310352451033784, 0.636502499121399) circle (0.02);
        \draw[fill=blue] (0.636502499121399, 0.053145049844817) circle (0.02);
        \draw[fill=blue] (0.310352451033784, 0.053145049844817) circle (0.02);
      \end{tikzpicture}
    }
  \end{figure}
\end{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=2]
      \begin{scope}[xshift=-.1em,yshift=-.1em]
        \draw (0,0) -- (0,1) -- (1,0) -- (0,0); \draw[fill=blue]
        (0,0) circle (0.025); \draw[fill=blue] (0.5,0) circle
        (0.025); \draw[fill=blue] (1,0) circle (0.025);
        \draw[fill=blue] (0.5,0.5) circle (0.025); \draw[fill=blue]
        (0,1) circle (0.025); \draw[fill=blue] (0,0.5) circle
        (0.025);
      \end{scope}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=2]
        \begin{scope}[xshift=-.1em,yshift=-.1em]
          ...
          \draw[fill=blue] (0.113,0.887) circle (0.025); 
          \draw[fill=blue] (0.5,0.5) circle (0.025); 
          \draw[fill=blue] (0.887,0.113) circle (0.025); 
        \end{scope}
        \draw[->,semithick] (0,1.075) -- node[right]{$x$} (1.075,0);
        \begin{scope}[xshift=1.15cm,yshift=1.15cm,rotate=180]
          \draw (0,0) -- (0,1) -- (1,0) -- (0,0); 
    ...
    \begin{column}{.5\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.8]
          ...
          \draw[blue] (0,0) .. controls(2.5,4) .. (5,4.5) node[right]{$N'(x)$};
          \draw[red] (0,0.4) .. controls(1,0.5) and (2.1,3.7) .. (4,4) .. controls (4.5,4.2) .. (5,5) node[right]{$N'(x)$};
        \end{tikzpicture}
