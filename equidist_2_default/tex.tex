...
\begin{figure}[h!]
  ...
  % }
  \subfigure[Impulse error for $p_1^L$ resp. $p_2^L$ if we use support points $\{0,1\}$] {
    \begin{tikzpicture}
  ...
  %   \end{tikzpicture}
  % }
  \subfigure[Impulse error for $p_1^L$ resp. $p_2^L$ if we use support points $\{0.5\pm\frac{\sqrt{3}}{6}\}$]{
    \begin{tikzpicture}
