...
\begin{figure}[h!t]
  \centering
  % \subfloat[Height for points $p_1^L$ and $p_3^L$ (same for $p_1^R$ and $p_3^R$ respectively).] {
  % \begin{tikzpicture}
  ...
  % }
  %   \subfloat[Height for points $p_2^L$ and $p_2^R$. Slight difference in scale.] {
  %   \begin{tikzpicture}
  ...
  % }
  \subfloat[Momentum for points $p_1^L$ resp. $p_3^L$] {
    \begin{tikzpicture}
  ...
  \subfloat[Momentum for points $p_2^L$]{
    \begin{tikzpicture}
  ...
  % \subfloat[Height and momentum for point $P_1$] {
  ...
  %   \subfloat[Height and momentum for point $P_2$] {
  ...
  %   \subfloat[Height and momentum for point $P_3$] {
