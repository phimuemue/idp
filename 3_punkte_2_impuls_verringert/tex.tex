...
\begin{figure}[h!t]
  \centering
  % \quad \subfloat[Height for points $p_1^L$ and $p_3^L$ (same for $p_1^R$ and $p_3^R$ respectively).] {
  % \begin{tikzpicture}
  ...
  % }
  %   \quad \subfloat[Height for points $p_2^L$ and $p_2^R$. Slight difference in scale.] {
  %   \begin{tikzpicture}
  ...
  % }
  \quad \subfloat[Momentum for points $p_1^L$ resp. $p_3^L$] {
    \begin{tikzpicture}
  ...
  \quad \subfloat[Momentum for points $p_2^L$]{
    \begin{tikzpicture}
  ...
  % \quad \subfloat[Height and momentum for point $P_1$] {
  ...
  %   \quad \subfloat[Height and momentum for point $P_2$] {
  ...
  %   \quad \subfloat[Height and momentum for point $P_3$] {
