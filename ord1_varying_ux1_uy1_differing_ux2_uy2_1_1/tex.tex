...
\begin{figure}[h!]
\centering
  \subfloat[$SE_x^1$, $SE_y^3$ is the same image mirrored by the plane $u_{x,1}=u_{y,1}$.] {
    \includegraphics[scale=\zoomfactor]{{{ord1_varying_ux1_uy1_differing_ux2_uy2_1_1/10.0_10.0_10.0_x_1.0_0.0_y_1.0_0.0f00}}}
  }
  \subfloat[$SE_x^3$, $SE_y^1$ is the same image mirrored by the plane $u_{x,1}=u_{y,1}$.] {
