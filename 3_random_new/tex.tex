...
\begin{figure}[h!t]
\centering
  \quad \subfloat[Momentum error for point $p_1^L$] {
    % \begin{tikzpicture}
  ...
  % \quad \subfloat[Height and Momentum for point $p_2^L$] {
  ...
  % }
  \quad \subfloat[Momentum error for point $p_3^L$] {
    % \begin{tikzpicture}
  ...
  \quad \subfloat[Momentum error for point $p_1^R$] {
  ...
  \quad \subfloat[Momentum error for point $p_2^R$] {
  ...
  % \quad \subfloat[Height and Momentum for point $p_3^R$] {
