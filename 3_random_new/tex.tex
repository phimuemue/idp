...
\begin{figure}[h!t]
\centering
  \subfloat[Momentum error for point $p_1^L$] {
    % \begin{tikzpicture}
  ...
  % \subfloat[Height and Momentum for point $p_2^L$] {
  ...
  % }
  \subfloat[Momentum error for point $p_3^L$] {
    % \begin{tikzpicture}
  ...
  \subfloat[Momentum error for point $p_1^R$] {
  ...
  \subfloat[Momentum error for point $p_2^R$] {
  ...
  % \subfloat[Height and Momentum for point $p_3^R$] {
