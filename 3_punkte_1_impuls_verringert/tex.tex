...
\begin{figure}[ht!]
\centering
  % \subfloat[Height and velocity for $p_1$] {
  ...
  % }
  \subfloat[Momentum error for $p_2^L$ resp. $p_2^R$] {
  ...
  \subfloat[Momentum error for $p_3^L$,$p_3^R$ resp. $p_1^R$] {
  ...
  % \subfloat[Momentum error for $p_1^R$] {
  %   % \begin{tikzpicture}
  ...
  %   \end{tikzpicture}
  % }
  % \subfloat[Height and velocity for $p_2^R$] {
  ...
  % \subfloat[Height and velocity for $p_3^R$] {
