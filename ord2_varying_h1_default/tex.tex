...
\centering
  ...
  \quad \subfloat[$SE^2_y$, $SE^4_x$, $SE^4_y$, $SE^6_x$] {
  ...
  % \quad \subfloat[3rd basis function, $y$-momentum -- 5th basis function, $x$-momentum] {
