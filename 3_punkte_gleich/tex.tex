...
\begin{figure}[ht]
\centering
  \quad \subfloat[Momentum error for point $p_1^L$, $p_3^L$, $p_1^R$ resp. $p_3^R$] {
    % \begin{tikzpicture}
  ...
  \quad \subfloat[Momentum error for point $p_2^L$ resp. $p_2^R$] {
    % \begin{tikzpicture}
  ...
  % \quad \subfloat[Momentum error for point $p_3^L$ resp. $p_3^R$] {    
  %   {    
  %     % \begin{tikzpicture}
  ...
  % \quad \subfloat[] {    \includegraphics[scale=\zoomfactor]{{{3_punkte_gleich/0.0_10.0_0.0_10.0_0.0_10.0_0.0_10.0_0.0_10.0_x_yf0}}}   }
  % \quad \subfloat[] {    \includegraphics[scale=\zoomfactor]{{{3_punkte_gleich/0.0_10.0_0.0_10.0_0.0_10.0_0.0_10.0_0.0_10.0_x_yf1}}}   }

  % \quad \subfloat[] {    \includegraphics[scale=\zoomfactor]{{{3_punkte_gleich/0.0_10.0_0.0_10.0_0.0_10.0_x_y_0.0_10.0_0.0_10.0f0}}}   }
  % \quad \subfloat[] {    \includegraphics[scale=\zoomfactor]{{{3_punkte_gleich/0.0_10.0_0.0_10.0_0.0_10.0_x_y_0.0_10.0_0.0_10.0f1}}}   }
