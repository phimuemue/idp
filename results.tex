...
\todo{Here we need some more explanations concerning the notation of $u_{x,j}$ and stuff\dots}
...
\todo{We have to do the explanation before we actually use it in the second line.}
...
\todo{Explain why we did not use Gauss-Integration?}
