...
\paragraph{What will we compare?}
...
\section{First insights for order 1}
...
To examine this, you can look at equations \eqref{eq:point-wise-approx-result-second-line} and \eqref{eq:stiffness-analysis-second-line-exact-approx-simple}.
...
For the resulting plots, if $\phi_i$ and $\phi_j$ are symmetric, this means the following:

\begin{itemize}
\item 2d-plots for the error of the $x$-momentum for basis function $\phi_i$ looks exactly like the 2d-plot for the error of the $y$-momentum for basis function $\phi_j$.
\item 3d-plots for the error of the $x$-momentum for basis function $\phi_i$ looks exactly like the 3d-plot for the error of the $y$-momentum for basis function $\phi_j$ with exchanged axes.
\end{itemize}
...
\label{sec:stiffness-analyiss-ord2-default-h1}
