...
%(more precisely a heatmap\todo{auch das wird normalerweise in der plot beschreibung erwaehnt}) 
for $\log_{10} h_1$ in figure \ref{fig:stiffness-analysis-log-singularities-ord-1}. We chose the coloring as follows:

\begin{itemize}
\item Red denotes values in $\left( -\infty, 0.7 \right] \cup \left[ 1.2, \infty \right)$ %Everything that is red resp. green denotes values above 1.2 resp. below 0.7.
