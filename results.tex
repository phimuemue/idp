...
We do that by applying the Gaussian quadrature over the previously mentioned support points. That is, we ``recycle'' the support points as integration points.
