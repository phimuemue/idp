...
As you can see, the value for $\log_{10}\frac{1-2x+24y}{-1+2y}$ is either 0 or below, or 1.25 or above. If we go back, we can conclude that either $h_1 \leq 10^0 = 1$ or $h_1\geq 10^{1.25} \approx 17$. We can conclude that -- for the assignment $h_2=h_3=10$ -- the only values for $h_1$ that could provoke a singularity are strongly different from 10.
