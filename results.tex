...
However, arbitrary choosing those can lead to the following disadvantages:

\begin{itemize}
\item Accuracy loss (which is the lesser evil).
\item Malconditioned matrices, which can prevent precomputing arrays.
  \marginpar{Der Satz klingt seltsam, insbesondere das Ende. Wenn ihr solche Statements macht, muesst ihr immer Referenzen angeben.\todo[Philipp]{Keine Ahnung, woher das ist.}}.
\end{itemize}
...
As we can see in table \ref{tab:basis-functions-for-low-degrees}, there are some symmetries for the basis functions. We will point out some of these symmetries here because they will help us in the analysis later.
...
However, we also investigated the situation for an equidistant distribution of support points. We find the corresponding results, as well as a short explanation of why this setting may be useful, in section \ref{sec:equidistant-distribution-of-support-points}.
...
For some more information about the developed tool please refer to section \ref{sec:making-the-whole-thing-interactive}.
...
We show the results of this experiment in figure \ref{fig:three-points-h1-}.
