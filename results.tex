...
\todo{Zwischen zwei nebeneinanderstehenden subfigures immer einheitlich viel Platz einfügen!}
...
It depends on the actual values and setup of basis functions to determine the exact relation between different heights, making it impractical to determine for the general case.
If that value is of interest, it will have to be examined with certain conditions predefined.

\todo{Ueberpruefen ob dieses Gelaber auch stimmt}\done{Scheint schon richtig zu sein.}
