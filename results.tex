...
As expected from our computations\todo{calculus?} in section \ref{sec:stiffness-analysis-ord2-default-var-ux1} and \ref{sec:basis-functions-other-properties}, the errors for the $y$ momentum of the 3rd basis function and the $x$ momentum of the 5th basis function is still 0. For a detailed computation\todo{calculus?}, refer to section \ref{sec:stiffness-analysis-ord2-default-var-ux1}.
