...
\centering
  ...
  % }
  \subfigure[Momentum error for $p_2^L$] {
    \begin{tikzpicture}
  ...
  \subfigure[Momentum error for $p_3^L$] {
    \begin{tikzpicture}
  ...
  % }
  %\subfigure[Momentum error for $p_1^R$] {
  %  \begin{tikzpicture}
  ...
  % }
  %\subfigure[Momentum error for $p_2^R$] {
  %  \begin{tikzpicture}
  ...
  %  \end{tikzpicture}
  %}
  %\subfigure[Momentum error for $p_3^R$] {
  %  \begin{tikzpicture}
